/************************************
 * Copyright (c) 2021-2025 MIT License
 * QFramework v1.0
 * Author Bourne
 * QQ 8510001
...
namespace QFramework
{
    ...
    public class TypeEventSystem : ITypeEventSystem
    {
        ...
        private Dictionary<Type, IRegistrations> mEventRegistrantion = new Dictionary<Type, IRegistrations>();
        ...
        public void Send<T>(T e)
        {
            ...
            if (mEventRegistrantion.TryGetValue(type, out registrations))
            {
        ...
        public IUnRegister Register<T>(Action<T> onEvent)
        {
            ...
            else
            {
                ...
                mEventRegistrantion.Add(type, registrations);
            }
